...
namespace avalara.comms.rest.v2.Api
{
    ...
    public interface ICustomizationApiSync : IApiAccessor
    {
        ...
        /// <returns>List&lt;ClientProfileConfigResponse&gt;</returns>
        List<ClientProfileConfigResponse> ApiV2ProfilesGetProfilesGet(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?));
        ...
        /// <param name="requestedProfileId">Configuration profile id to be fetched  Use 0 to indicate all profiles  Null value will use profile id from request or 0 if not set. (optional)</param>
        /// <param name="itemType">Item Type  Examples:    Configuration, Bundle, Exclusion, Override, All (optional)</param>
        /// <returns>ApiResponse of List&lt;ClientProfileConfigResponse&gt;</returns>
        ApiResponse<List<ClientProfileConfigResponse>> ApiV2ProfilesGetProfilesGetWithHttpInfo(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?));
    ...
    public interface ICustomizationApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of List&lt;ClientProfileConfigResponse&gt;</returns>
        System.Threading.Tasks.Task<List<ClientProfileConfigResponse>> ApiV2ProfilesGetProfilesGetAsync(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="itemType">Item Type  Examples:    Configuration, Bundle, Exclusion, Override, All (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ClientProfileConfigResponse&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ClientProfileConfigResponse>>> ApiV2ProfilesGetProfilesGetWithHttpInfoAsync(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class CustomizationApi : ICustomizationApi
    {
        ...
        /// <param name="itemType">Item Type  Examples:    Configuration, Bundle, Exclusion, Override, All (optional)</param>
        /// <returns>List&lt;ClientProfileConfigResponse&gt;</returns>
        public List<ClientProfileConfigResponse> ApiV2ProfilesGetProfilesGet(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?))
        {
            avalara.comms.rest.v2.Client.ApiResponse<List<ClientProfileConfigResponse>> localVarResponse = ApiV2ProfilesGetProfilesGetWithHttpInfo(requestedClientId, requestedProfileId, itemType);
        ...
        /// <param name="itemType">Item Type  Examples:    Configuration, Bundle, Exclusion, Override, All (optional)</param>
        /// <returns>ApiResponse of List&lt;ClientProfileConfigResponse&gt;</returns>
        public avalara.comms.rest.v2.Client.ApiResponse<List<ClientProfileConfigResponse>> ApiV2ProfilesGetProfilesGetWithHttpInfo(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?))
        {
            ...
            var localVarResponse = this.Client.Get<List<ClientProfileConfigResponse>>("/api/v2/profiles/GetProfiles", localVarRequestOptions, this.Configuration);
        ...
        {
            avalara.comms.rest.v2.Client.ApiResponse<List<ClientProfileConfigResponse>> localVarResponse = await ApiV2ProfilesGetProfilesGetWithHttpInfoAsync(requestedClientId, requestedProfileId, itemType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ClientProfileConfigResponse&gt;)</returns>
        public async System.Threading.Tasks.Task<avalara.comms.rest.v2.Client.ApiResponse<List<ClientProfileConfigResponse>>> ApiV2ProfilesGetProfilesGetWithHttpInfoAsync(int? requestedClientId = default(int?), int? requestedProfileId = default(int?), ClientProfileConfigTypes? itemType = default(ClientProfileConfigTypes?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ClientProfileConfigResponse>>("/api/v2/profiles/GetProfiles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
