...
namespace avalara.comms.rest.v2.Api
{
    ...
    public interface ITaxCalculationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CalcTaxesResponse> ApiV2AfcCalcTaxesPostAsync(CalcTaxesRequest calcTaxesRequest = default(CalcTaxesRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CalcTaxesResponse>> ApiV2AfcCalcTaxesPostWithHttpInfoAsync(CalcTaxesRequest calcTaxesRequest = default(CalcTaxesRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Commits or un-commits a document code.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CommitResponse> ApiV2AfcCommitPostAsync(CommitRequest commitRequest = default(CommitRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CommitResponse>> ApiV2AfcCommitPostWithHttpInfoAsync(CommitRequest commitRequest = default(CommitRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TaxCalculationApi : ITaxCalculationApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CalcTaxesResponse</returns>
        public async System.Threading.Tasks.Task<CalcTaxesResponse> ApiV2AfcCalcTaxesPostAsync(CalcTaxesRequest calcTaxesRequest = default(CalcTaxesRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            avalara.comms.rest.v2.Client.ApiResponse<CalcTaxesResponse> localVarResponse = await ApiV2AfcCalcTaxesPostWithHttpInfoAsync(calcTaxesRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CalcTaxesResponse)</returns>
        public async System.Threading.Tasks.Task<avalara.comms.rest.v2.Client.ApiResponse<CalcTaxesResponse>> ApiV2AfcCalcTaxesPostWithHttpInfoAsync(CalcTaxesRequest calcTaxesRequest = default(CalcTaxesRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<CalcTaxesResponse>("/api/v2/afc/CalcTaxes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CommitResponse</returns>
        public async System.Threading.Tasks.Task<CommitResponse> ApiV2AfcCommitPostAsync(CommitRequest commitRequest = default(CommitRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            avalara.comms.rest.v2.Client.ApiResponse<CommitResponse> localVarResponse = await ApiV2AfcCommitPostWithHttpInfoAsync(commitRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CommitResponse)</returns>
        public async System.Threading.Tasks.Task<avalara.comms.rest.v2.Client.ApiResponse<CommitResponse>> ApiV2AfcCommitPostWithHttpInfoAsync(CommitRequest commitRequest = default(CommitRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<CommitResponse>("/api/v2/afc/Commit", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
