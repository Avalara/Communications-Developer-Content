...
namespace avalara.comms.rest.v2.Model
{
    ...
    public partial class ModelConfiguration : IEquatable<ModelConfiguration>, IValidatableObject
    {
        ...
        public ModelConfiguration(List<TrafficStudyOverride> trafficStudyOverrides = default(List<TrafficStudyOverride>), bool? returnNonBillable = default(bool?), int? taxOnTaxAlgorithm = default(int?), int? selfTaxAlgorithm = default(int?))
        {
