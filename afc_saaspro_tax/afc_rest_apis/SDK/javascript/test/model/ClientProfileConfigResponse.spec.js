...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaasPro.ClientProfileConfigResponse();
  });
  ...
  describe('ClientProfileConfigResponse', function() {
    it('should create an instance of ClientProfileConfigResponse', function() {
      // uncomment below and update the code to test ClientProfileConfigResponse
      //var instane = new SaasPro.ClientProfileConfigResponse();
      //expect(instance).to.be.a(SaasPro.ClientProfileConfigResponse);
    });
