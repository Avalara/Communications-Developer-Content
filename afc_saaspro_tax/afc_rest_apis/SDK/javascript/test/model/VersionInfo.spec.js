...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaasPro.VersionInfo();
  });
  ...
  describe('VersionInfo', function() {
    it('should create an instance of VersionInfo', function() {
      ...
      //var instane = new SaasPro.VersionInfo();
      //expect(instance).to.be.a(SaasPro.VersionInfo);
    });

    it('should have the property afcEngineVersion (base name: "AfcEngineVersion")', function() {
      // uncomment below and update the code to test the property afcEngineVersion
      //var instane = new SaasPro.VersionInfo();
