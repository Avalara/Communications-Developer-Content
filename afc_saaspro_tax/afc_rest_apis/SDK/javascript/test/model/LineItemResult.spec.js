...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaasPro.LineItemResult();
  });
  ...
  describe('LineItemResult', function() {
    it('should create an instance of LineItemResult', function() {
      // uncomment below and update the code to test LineItemResult
      //var instane = new SaasPro.LineItemResult();
      //expect(instance).to.be.a(SaasPro.LineItemResult);
    });
