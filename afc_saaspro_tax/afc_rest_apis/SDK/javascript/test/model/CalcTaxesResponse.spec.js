...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaasPro.CalcTaxesResponse();
  });
  ...
  describe('CalcTaxesResponse', function() {
    it('should create an instance of CalcTaxesResponse', function() {
      // uncomment below and update the code to test CalcTaxesResponse
      //var instane = new SaasPro.CalcTaxesResponse();
      //expect(instance).to.be.a(SaasPro.CalcTaxesResponse);
    });
