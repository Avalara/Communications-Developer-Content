...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaasPro.GeoBatchLog();
  });
  ...
  describe('GeoBatchLog', function() {
    it('should create an instance of GeoBatchLog', function() {
      // uncomment below and update the code to test GeoBatchLog
      //var instane = new SaasPro.GeoBatchLog();
      //expect(instance).to.be.a(SaasPro.GeoBatchLog);
    });
