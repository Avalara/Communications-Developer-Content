...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaasPro.ReportingInformation();
  });
  ...
  describe('ReportingInformation', function() {
    it('should create an instance of ReportingInformation', function() {
      ...
      //var instane = new SaasPro.ReportingInformation();
      //expect(instance).to.be.a(SaasPro.ReportingInformation);
    });
    ...
    it('should have the property ccydesc (base name: "ccydesc")', function() {
      // uncomment below and update the code to test the property ccydesc
      //var instane = new SaasPro.ReportingInformation();
      //expect(instance).to.be();
    });
