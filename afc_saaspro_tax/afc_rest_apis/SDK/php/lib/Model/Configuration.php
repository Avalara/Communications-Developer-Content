...
class Configuration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['traffic_study_overrides'] = $data['traffic_study_overrides'] ?? null;
        $this->container['return_non_billable'] = $data['return_non_billable'] ?? null;
        $this->container['tax_on_tax_algorithm'] = $data['tax_on_tax_algorithm'] ?? null;
        $this->container['self_tax_algorithm'] = $data['self_tax_algorithm'] ?? null;
    }
