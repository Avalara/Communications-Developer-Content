 ...
 */
class ClientProfileConfigResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['profile_config_id'] = $data['profile_config_id'] ?? null;
        $this->container['profile_ids'] = $data['profile_ids'] ?? null;
        $this->container['client_id'] = $data['client_id'] ?? null;
        $this->container['last_update_by'] = $data['last_update_by'] ?? null;
        $this->container['active'] = $data['active'] ?? null;
        $this->container['settings'] = $data['settings'] ?? null;
        $this->container['exclusions'] = $data['exclusions'] ?? null;
        $this->container['bundles'] = $data['bundles'] ?? null;
        $this->container['nexus'] = $data['nexus'] ?? null;
