...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['exms'] = $data['exms'] ?? null;
        $this->container['itms'] = $data['itms'] ?? null;
        $this->container['invm'] = $data['invm'] ?? null;
        $this->container['dtl'] = $data['dtl'] ?? null;
        $this->container['summ'] = $data['summ'] ?? null;
        $this->container['opt'] = $data['opt'] ?? null;
        $this->container['acct'] = $data['acct'] ?? null;
        $this->container['custref'] = $data['custref'] ?? null;
        $this->container['invn'] = $data['invn'] ?? null;
        $this->container['bcyc'] = $data['bcyc'] ?? null;
        $this->container['bpd'] = $data['bpd'] ?? null;
        $this->container['ccycd'] = $data['ccycd'] ?? null;
    }
