...
class TaxExemption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['frc'] = $data['frc'] ?? null;
        $this->container['loc'] = $data['loc'] ?? null;
        $this->container['tpe'] = $data['tpe'] ?? null;
        $this->container['lvl'] = $data['lvl'] ?? null;
        $this->container['cat'] = $data['cat'] ?? null;
        $this->container['dom'] = $data['dom'] ?? null;
        $this->container['scp'] = $data['scp'] ?? null;
        $this->container['exnb'] = $data['exnb'] ?? null;
    }
