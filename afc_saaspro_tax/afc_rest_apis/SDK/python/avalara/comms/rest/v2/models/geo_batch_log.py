...
class GeoBatchLog(object):
    ...
    @property
    def log(self):
        """Gets the log of this GeoBatchLog.  # noqa: E501

        Log of provided Process Id  # noqa: E501

        :return: The log of this GeoBatchLog.  # noqa: E501
        :rtype: list[GeoBatchLogItem]
        """
        return self._log

    @log.setter
    def log(self, log):
        """Sets the log of this GeoBatchLog.

        Log of provided Process Id  # noqa: E501

        :param log: The log of this GeoBatchLog.  # noqa: E501
        :type: list[GeoBatchLogItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GeoBatchLog):
            return False
