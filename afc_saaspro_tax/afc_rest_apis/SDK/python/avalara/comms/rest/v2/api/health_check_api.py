...
class HealthCheckApi(object):
    ...
    def api_v2_health_check_get(self, **kwargs):  # noqa: E501
        ...
        return self.api_v2_health_check_get_with_http_info(**kwargs)  # noqa: E501

    def api_v2_health_check_get_with_http_info(self, **kwargs):  # noqa: E501
        """Health check that confirms the service is operational and ready to use  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_health_check_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method api_v2_health_check_get" % key
                )
