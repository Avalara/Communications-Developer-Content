...
class CustomizationApi(object):
    ...
    def api_v2_profiles_set_bundles_post(self, **kwargs):  # noqa: E501
        """Creates or updates bundle packages and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_bundles_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param SetTaxCalculationSettingRequest set_tax_calculation_setting_request:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_v2_profiles_set_bundles_post_with_http_info(**kwargs)  # noqa: E501

    def api_v2_profiles_set_bundles_post_with_http_info(self, **kwargs):  # noqa: E501
        """Creates or updates bundle packages and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_bundles_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['set_tax_calculation_setting_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_profiles_set_bundles_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'set_tax_calculation_setting_request' in local_var_params:
            body_params = local_var_params['set_tax_calculation_setting_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
    ...
    def api_v2_profiles_set_config_post(self, **kwargs):  # noqa: E501
        """Creates or updates configuration settings and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_config_post(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_v2_profiles_set_config_post_with_http_info(**kwargs)  # noqa: E501

    def api_v2_profiles_set_config_post_with_http_info(self, **kwargs):  # noqa: E501
        """Creates or updates configuration settings and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_config_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_profiles_set_config_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def api_v2_profiles_set_exclusions_post(self, **kwargs):  # noqa: E501
        """Creates or updates exclusions and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_exclusions_post(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_v2_profiles_set_exclusions_post_with_http_info(**kwargs)  # noqa: E501

    def api_v2_profiles_set_exclusions_post_with_http_info(self, **kwargs):  # noqa: E501
        """Creates or updates exclusions and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_exclusions_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_profiles_set_exclusions_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def api_v2_profiles_set_overrides_post(self, **kwargs):  # noqa: E501
        """Creates or updates overrides and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_overrides_post(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_v2_profiles_set_overrides_post_with_http_info(**kwargs)  # noqa: E501

    def api_v2_profiles_set_overrides_post_with_http_info(self, **kwargs):  # noqa: E501
        """Creates or updates overrides and associated profile mappings.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_profiles_set_overrides_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_profiles_set_overrides_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
