...
class NexusConfig(object):
    ...
    @property
    def state(self):
        """Gets the state of this NexusConfig.  # noqa: E501

        State abbreviation  # noqa: E501

        :return: The state of this NexusConfig.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this NexusConfig.

        State abbreviation  # noqa: E501

        :param state: The state of this NexusConfig.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NexusConfig):
            return False
