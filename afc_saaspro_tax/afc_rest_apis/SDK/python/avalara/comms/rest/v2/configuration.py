...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of avalara.comms.rest.v2.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = avalara.comms.rest.v2.Configuration(
    ...
    Note you can use the constants defined in the avalara.comms.rest.v2.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = avalara.comms.rest.v2.Configuration(
        signing_info = avalara.comms.rest.v2.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("avalara.comms.rest.v2")
