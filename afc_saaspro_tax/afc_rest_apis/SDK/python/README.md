...
## Using TLS 1.2 or higherAvalara endpoints require a minimum of TLS 1.2. For a Python application, the best version of TLS will be used automatically. To enforce TLS 1.2 in your application Python, please insure that the latest version of OpenSSL is downloaded. The OpenSSL version should be at or above 1.0.1.Further readingPython2: https://docs.python.org/2/library/ssl.htmlPython3: https://docs.python.org/3/library/ssl.htmlOpenSSL Changelog: https://www.openssl.org/news/changelog.html#openssl-101## Getting Started
