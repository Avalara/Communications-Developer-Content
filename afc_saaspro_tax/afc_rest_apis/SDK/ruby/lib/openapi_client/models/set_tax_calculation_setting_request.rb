...
module OpenapiClient
  ...
  class SetTaxCalculationSettingRequest
    ...
    attr_accessor :link_profile_ids

    # Profile(s) to be added to configuration  Leave null to not change profiles associated with configuration settings
    attr_accessor :unlink_profile_ids
    ...
    attr_accessor :replace_existing_links
    ...
    def self.openapi_types
      {
        ...
        :'link_profile_ids' => :'Array<Integer>',
        :'unlink_profile_ids' => :'Array<Integer>',
        :'client_id' => :'Integer',
        :'deactivate' => :'Boolean',
        :'description' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SetTaxCalculationSettingRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SetTaxCalculationSettingRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'link_profile_ids')
        if (value = attributes[:'link_profile_ids']).is_a?(Array)
          self.link_profile_ids = value
        end
      end

      if attributes.key?(:'unlink_profile_ids')
        if (value = attributes[:'unlink_profile_ids']).is_a?(Array)
          self.unlink_profile_ids = value
        end
      end
      ...
      if attributes.key?(:'replace_existing_links')
        self.replace_existing_links = attributes[:'replace_existing_links']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          link_profile_ids == o.link_profile_ids &&
          unlink_profile_ids == o.unlink_profile_ids &&
          client_id == o.client_id &&
          deactivate == o.deactivate &&
          description == o.description &&
          replace_existing_links == o.replace_existing_links &&
          settings == o.settings &&
    ...
    def hash
      [profile_config_id, link_profile_ids, unlink_profile_ids, client_id, deactivate, description, replace_existing_links, settings, exclusions, bundles, nexus, overrides].hash
    end
