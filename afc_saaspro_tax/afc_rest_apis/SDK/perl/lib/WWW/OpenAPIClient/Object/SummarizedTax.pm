...
#
package WWW::OpenAPIClient::Object::SummarizedTax;
...
__PACKAGE__->class_documentation({description => 'Tax data for summarized invoice taxes.',
                                  class => 'SummarizedTax',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'max' => {
        datatype => 'double',
        base_name => 'max',
        description => 'Maximum base for tax bracket.',
        format => '',
        read_only => '',
            },
    'min' => {
        datatype => 'double',
        base_name => 'min',
        description => 'Minimum base for tax bracket.',
        format => '',
        read_only => '',
            },
    'tchg' => {
