...
#
package WWW::OpenAPIClient::Object::CompanyData;
...
__PACKAGE__->class_documentation({description => 'Container class for json properties associated with v2.CalcTaxes company data',
                                  class => 'CompanyData',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'bscl' => {
        datatype => 'int',
        base_name => 'bscl',
        description => 'Business class. 0 &#x3D; ILEC, 1 &#x3D; CLEC.',
        format => '',
        read_only => '',
            },
    'svcl' => {
    ...
    'reg' => {
        datatype => 'boolean',
        base_name => 'reg',
        description => 'Indicates if company is regulated.',
        format => '',
        read_only => '',
            },
    'excl' => {
        datatype => 'ARRAY[Exclusion]',
        base_name => 'excl',
    ...
    'idnt' => {
        datatype => 'string',
        base_name => 'idnt',
        description => 'An optional company identifier for reporting',
        format => '',
        read_only => '',
            },
});
