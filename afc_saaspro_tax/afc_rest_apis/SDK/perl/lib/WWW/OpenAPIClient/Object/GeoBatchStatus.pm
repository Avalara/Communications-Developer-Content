...
#
package WWW::OpenAPIClient::Object::GeoBatchStatus;
...
__PACKAGE__->class_documentation({description => 'Individual File Status For Geo Batch result',
...
__PACKAGE__->method_documentation({
    'process_id' => {
        datatype => 'int',
        base_name => 'ProcessId',
        description => 'Process ID for Batch file.',
        format => '',
        read_only => '',
            },
    'request_date' => {
        datatype => 'DateTime',
        base_name => 'RequestDate',
    ...
    'status' => {
        datatype => 'string',
        base_name => 'Status',
        description => 'Status Of Batch File.',
        format => '',
        read_only => '',
            },
    'downloads' => {
