...
#
package WWW::OpenAPIClient::Object::GeoBatchDownloadResponse;
...
__PACKAGE__->class_documentation({description => 'Response body for Geo Batch Submit File API.',
...
__PACKAGE__->method_documentation({
    ...
    'input_file_download' => {
        datatype => 'string',
        base_name => 'InputFileDownload',
        description => 'Input File Download.',
        format => '',
        read_only => '',
            },
    'output_file' => {
