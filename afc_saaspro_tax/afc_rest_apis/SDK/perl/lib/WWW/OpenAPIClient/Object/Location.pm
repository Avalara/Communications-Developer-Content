...
__PACKAGE__->method_documentation({
    ...
    'int' => {
        datatype => 'boolean',
        base_name => 'int',
        description => 'Indicates if the location is within city limits.  Default: true.',
        format => '',
        read_only => '',
            },
    'geo' => {
        datatype => 'boolean',
        base_name => 'geo',
        description => 'Indicates if this address should be geocoded in order to obtain taxing jurisdiction.  Default: false.',
        format => '',
        read_only => '',
            },
    'pcd' => {
    ...
    'fips' => {
        datatype => 'string',
        base_name => 'fips',
        description => 'FIPS code for taxing jurisdiction.',
        format => '',
        read_only => '',
            },
    'addr' => {
