...
${nuget_cmd} install src/avalara.comms.rest.v2/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/avalara.comms.rest.v2.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/avalara.comms.rest.v2.dll \
-recurse:'src/avalara.comms.rest.v2/*.cs' \
-doc:bin/avalara.comms.rest.v2.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/avalara.comms.rest.v2.dll was created successfully"
fi
