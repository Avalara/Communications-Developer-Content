...
namespace avalara.comms.rest.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxCalculationSettingsResponse :  IEquatable<TaxCalculationSettingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxCalculationSettingsResponse" /> class.
        /// </summary>
        ...
        public TaxCalculationSettingsResponse(long? profileConfigId = default(long?), List<int> profileIds = default(List<int>), int? clientId = default(int?), string lastUpdateBy = default(string), bool? active = default(bool?), Configuration settings = default(Configuration), List<ExclusionConfig> exclusions = default(List<ExclusionConfig>), List<BundleConfig> bundles = default(List<BundleConfig>), List<NexusConfig> nexus = default(List<NexusConfig>), OverrideConfig overrides = default(OverrideConfig), string description = default(string), string error = default(string), string itemType = default(string), List<Error> errors = default(List<Error>), List<Warning> warnings = default(List<Warning>), List<Status> status = default(List<Status>))
        {
        ...
        {
            return this.Equals(input as TaxCalculationSettingsResponse);
        }

        /// <summary>
        /// Returns true if TaxCalculationSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxCalculationSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxCalculationSettingsResponse input)
        {
            if (input == null)
                return false;
